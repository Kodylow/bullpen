...
//!
//! assert_eq!(PplxChatModel::Codellama34bInstruct.to_string(),
//! "codellama-34b-instruct"); assert_eq!(PplxChatModel::Llama213bChat.to_string(),
//! "llama-2-13b-chat"); assert_eq!(PplxChatModel::Llama270bChat.to_string(),
//! "llama-2-70b-chat"); assert_eq!(PplxChatModel::Mistral7bInstruct.to_string(),
//! "mistral-7b-instruct"); assert_eq!(PplxChatModel::Openhermes2Mistral7b.
//! to_string(), "openhermes-2-mistral-7b");
//! assert_eq!(PplxChatModel::Openhermes25Mistral7b.to_string(),
//! "openhermes-2.5-mistral-7b"); assert_eq!(PplxChatModel::Pplx7bChatAlpha.
//! to_string(), "pplx-7b-chat-alpha"); assert_eq!(PplxChatModel::Pplx70bChatAlpha.
